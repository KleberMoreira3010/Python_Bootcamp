...
if transacao['valor'] > 10000 or transacao['hora'] <9 and transacao['hora'] >18:
    print('Transacao irregular')
else:
    print("Transaçao Nornal")    
...
numero = int(input("NUmero maior que 0 e menor que 10"))
